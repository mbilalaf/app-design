...
class CharmLevelBody extends StatelessWidget {
  const CharmLevelBody({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // Header
            LevelHeader(
              colorOne: AppColors.blue.withOpacity(0.5),
              colorTwo: AppColors.blue,
            ),
            ...
            // Level Tiles
            const LevelTile(
              image: 'assets/images/star-7.png',
              level: '1-9',
              levelNo: '9',
            ...
            const SizedBox(height: 12),
            const LevelTile(
              image: 'assets/images/star-9.png',
              level: '20-29',
              levelNo: '29',
            ...
            const SizedBox(height: 12),
            const LevelTile(
              image: 'assets/images/star-10.png',
              level: '40-49',
              levelNo: '39',
            ...
            const SizedBox(height: 12),
            const LevelTile(
              image: 'assets/images/star-11.png',
              level: '50-59',
              levelNo: '59',
