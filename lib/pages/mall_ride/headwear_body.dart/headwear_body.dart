...
import 'package:maaz_design/pages/add_badges/add_badges.dart';
import 'package:maaz_design/pages/mall_ride/widgets/item_card.dart';

class HeadwearBody extends StatelessWidget {
  const HeadwearBody({super.key});
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const AddBadges(),
                      ),
                    );
                  },
                  child: ItemCard(
